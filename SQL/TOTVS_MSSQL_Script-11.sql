...
SELECT * FROM PROTHEUS12_R27.dbo.SG1010 WHERE G1_COD = 'M-042-005-648' AND G1_REVFIM <> 'ZZZ' AND D_E_L_E_T_ <> '*';
...
SELECT * FROM PROTHEUS12_R27.dbo.SG1010 WHERE G1_COD = 'M-059-201-999'
AND G1_REVFIM <> 'ZZZ' AND D_E_L_E_T_ <> '*'
AND G1_REVFIM = 
(SELECT MAX(G1_REVFIM) FROM PROTHEUS12_R27.dbo.SG1010 
WHERE G1_COD = 'M-059-201-999'AND G1_REVFIM <> 'ZZZ' AND D_E_L_E_T_ <> '*');
